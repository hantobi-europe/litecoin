...
{
    const char* pszTimestamp = "we are aox";
    const CScript genesisOutputScript = CScript() << ParseHex("0425894db7e504132b6b42db9ca68983a64097f92f6495910cae14c40347d9c1c98aabbaac2cf6502ec4556563d0c8b79f7237553099216b30966ccdf357f83897") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1609088305, 2084592165, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x282acd4d38a3382a33b026a87b37be4efff322fd4c629d13f9ab00abbe0e76fb"));
        assert(genesis.hashMerkleRoot == uint256S("0xc62db0e15f3fa1e79285f52e02bcb214cf8e26371809bf3cba077ab4dded3f05"));
